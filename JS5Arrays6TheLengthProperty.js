...
a) We use dot notation, chaining a period with the property name to the array, to access the length property of the newYearsResolutions array.

b) Then we log the length of newYearsResolution to the console.

c) Since newYearsResolution has two elements, so 2 would be logged to the console.
